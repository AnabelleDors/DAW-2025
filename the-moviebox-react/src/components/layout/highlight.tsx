...
export function Highlight() {
    ...
    return (
        <section
            className="flex bg-[left_calc((50vw-170px)-340px)_top] bg-cover relative"
            style={{
                backgroundImage: `url(${selectedMovie.highlight})`
            }}
        >
            <div className="absolute inset-0 z-10 bg-gradient-to-r from-[#111] from-[calc((50vw-70px)-340px)] via-[#111]/70 via-50% to-[#111]/70"></div>
            ...
            <div className="container relative z-20 mx-auto flex gap-8 py-8">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex flex-col gap-2">
                        <h4 className="pb-2 pt-12 text-2xl font-normal text-white">
                            Sinopse
                        </h4>
                    ...
                    <div className="my-6 flex gap-4">
                        <button className="cursor-pointer rounded border-none bg-[#e50914] px-6 py-3 font-bold text-white transition hover:bg-[#b8070f]">
                            Assistir
                        </button>

                        <button className="cursor-pointer rounded border border-white/30 bg-white/20 px-6 py-3 text-white transition hover:bg-white/30">
                            Detalhes
                        </button>
